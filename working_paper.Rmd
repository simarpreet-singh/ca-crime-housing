...
**Will be removed in the final paper**
...
* **OpenJustice** - *Crimes and Clearances Data (Including Arson)*
  ...
  + [Download Data Dictionary](https://openjustice.doj.ca.gov/downloads/Crimes-Clear-Arson%20Context.pdf)
...
**Summary Statistics of California Crimes and Clearances**

These statistics are divided by the crime variables and the clearances variables.

***Crimes***:

```{r}
# crime_00_16_raw %>% select(col1:col10) %>% summary()
```
